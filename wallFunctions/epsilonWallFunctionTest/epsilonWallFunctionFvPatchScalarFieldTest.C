...
#include "epsilonWallFunctionFvPatchScalarFieldTest.H"
...
Foam::epsilonWallFunctionFvPatchScalarFieldTest::calculate
(
...
void Foam::epsilonWallFunctionFvPatchScalarFieldTest::updateCoeffsMaster()
{
    ...
    {
        if (isA<epsilonWallFunctionFvPatchScalarFieldTest>(epsilonBf[patchi]))
        {
            const epsilonWallFunctionFvPatchScalarFieldTest& epsilonPf =
                refCast<const epsilonWallFunctionFvPatchScalarFieldTest>
                (epsilonBf[patchi]);
...
void Foam::epsilonWallFunctionFvPatchScalarFieldTest::manipulateMatrixMaster
(
...
Foam::epsilonWallFunctionFvPatchScalarFieldTest::
epsilonWallFunctionFvPatchScalarFieldTest
(
    const fvPatch& p,
...
epsilonWallFunctionFvPatchScalarFieldTest
(
    const epsilonWallFunctionFvPatchScalarFieldTest& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
epsilonWallFunctionFvPatchScalarFieldTest
(
    const epsilonWallFunctionFvPatchScalarFieldTest& ewfpsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void Foam::epsilonWallFunctionFvPatchScalarFieldTest::map
(
...
void Foam::epsilonWallFunctionFvPatchScalarFieldTest::reset
(
    const fvPatchScalarField& ptf
)
{
...
void Foam::epsilonWallFunctionFvPatchScalarFieldTest::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::epsilonWallFunctionFvPatchScalarFieldTest::manipulateMatrix
(
    fvMatrix<scalar>& matrix
)
{
